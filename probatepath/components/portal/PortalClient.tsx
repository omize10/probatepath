  ...
  return (
    <div className="space-y-1 rounded-2xl bg-[color:var(--bg-muted)] px-4 py-3 text-sm text-[color:var(--text-secondary)]">
      ...
      <p>
        ...
        <a href="tel:6041234567" className="font-semibold text-[color:var(--ink)]">
          604-123-4567
        </a>{" "}
        or email{" "}
        <a href="mailto:help@probatedesk.com" className="font-semibold text-[color:var(--ink)]">
          help@probatedesk.com
        </a>
        .
      </p>
    </div>
