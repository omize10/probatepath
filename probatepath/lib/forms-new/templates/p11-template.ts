/**
 * Form P11 - Affidavit of Assets and Liabilities for Non-Domiciled Estate Grant
...
export function generateP11HTML(data: P11Data): string {
...
<head>
  ...
  <title>Form P11 - Affidavit of Assets and Liabilities for Non-Domiciled Estate Grant</title>
  <style>
    @page {
      size: 8.5in 11in;
      margin: 0.5in 0.75in;
...
<div class="form-header">
  <div class="form-number">Form P11 (Rule 25-3 (2))</div>
</div>
...
<div class="form-title">Affidavit of Assets and Liabilities for Non-Domiciled Estate Grant</div>
...
<div class="sub-paragraph">(a) all of the property of the deceased within British Columbia, irrespective of its nature or value, that passes to the applicant in the applicant's capacity as the deceased's personal representative,</div>
...
<div class="exhibit-section">
  ...
  <div style="margin-top: 18pt; font-weight: bold;">Part III Intangible Personal Property (including bank accounts, investments, and other valuable items that cannot be touched by hand)</div>
