/**
 * Form P7 - Affidavit of Applicant for Ancillary Grant of Administration without Will Annexed
...
export function generateP7HTML(data: P7Data): string {
...
<head>
  ...
  <title>Form P7 - Affidavit of Applicant for Ancillary Grant of Administration without Will Annexed</title>
  <style>
    @page {
      size: 8.5in 11in;
      margin: 0.5in 0.75in;
...
<div class="form-header">
  <div class="form-number">Form P7 (Rule 25-3 (2))</div>
</div>
...
<div class="form-title">Affidavit of Applicant for Ancillary Grant of Administration without Will Annexed</div>
...
<!-- Paragraph 1 -->
<div class="paragraph">
  1 I am the applicant/one of the applicants referred to in the submission for estate grant in relation to the estate of <span class="field-line">${formatFullNameCaps(data.deceased)}</span> (the "deceased"), and am applying for an ancillary grant of administration without will annexed in relation to the grant of administration without will annexed (the "foreign grant") issued by the <span class="field-line">${data.foreignGrant?.courtName || underline(30)}</span> of <span class="field-line">${data.foreignGrant?.jurisdiction || underline(25)}</span> on <span class="field-line">${data.foreignGrant?.dateIssued || underline(15)}</span> in relation to the estate of the deceased.
</div>
...
<!-- Paragraph 7 -->
<div class="paragraph">
  7 <span class="instruction">[Check whichever one of the immediately following 3 boxes is correct and provide any required information.]</span>
</div>

<div class="checkbox-item">
  <span class="checkbox">${checkbox(true)}</span>
  <span>I am not aware of there being any application for a grant of probate or administration, or any grant of probate or administration, or equivalent, having been issued, in relation to the deceased, in British Columbia other than the foreign grant.</span>
</div>

<div class="checkbox-item">
  <span class="checkbox">${checkbox(false)}</span>
  <span>The following grant(s) of probate or administration, or equivalent, has/have been issued in relation to the deceased in British Columbia: <span class="field-line">${underline(40)}</span>. I believe that that grant is/those grants are not relevant to this application for the following reasons: <span class="field-line">${underline(40)}</span></span>
</div>
