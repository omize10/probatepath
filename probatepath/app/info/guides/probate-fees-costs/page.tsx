        ...
        <div id="calculator" className="scroll-mt-24 not-prose rounded-2xl border-2 border-[color:var(--brand)]/30 bg-gradient-to-r from-blue-50/50 to-white p-6 my-8">
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            <div className="flex-1">
              ...
              <p className="text-sm text-[color:var(--text-secondary)] mt-1">Enter your estate value and instantly see your total court costs with a full bracket breakdown.</p>
            </div>
            <Link
