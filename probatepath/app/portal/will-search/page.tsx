        ...
        {mailedAt ? (
          <div className="space-y-4">
            <div className="space-y-3 rounded-2xl bg-white px-6 py-6 shadow-sm">
              ...
              <p className="text-sm text-[color:var(--text-secondary)]">You told us you mailed your will search on {formatDate(mailedAt)}.</p>
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                ...
                {waitingUntil ? (
                  <p className="text-xs text-[color:var(--text-secondary)]">Earliest next step: {formatDate(waitingUntil)} (21-day wait after notices will start there).</p>
                ) : null}
              </div>
            </div>
