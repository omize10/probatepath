/**
 * Form P15 - Supplemental Affidavit of Assets and Liabilities for Non-Domiciled Estate Grant
...
export function generateP15HTML(data: P15Data): string {
...
<head>
  ...
  <title>Form P15 - Supplemental Affidavit of Assets and Liabilities for Non-Domiciled Estate Grant</title>
  <style>
    @page {
      size: 8.5in 11in;
      margin: 0.5in 0.75in;
...
<div class="form-header">
  <div class="form-number">Form P15 (Rule 25-3 (9))</div>
</div>
...
<div class="form-title">Supplemental Affidavit of Assets and Liabilities for Non-Domiciled Estate Grant</div>
