...
export default function PortalPricingPage() {
  ...
  const [selectedTier, setSelectedTier] = useState<Tier | null>("standard");
    ...
    <div className="mx-auto max-w-6xl space-y-12 px-4 py-12 sm:px-6 lg:px-8">
      <div className="space-y-4 text-center">
        ...
        <p className="mx-auto max-w-2xl text-base text-[color:var(--muted-ink)]">
          Based on your estate details, we recommend the <strong>Standard plan</strong> for peace of mind.
        </p>
      </div>
              ...
              <Card
                ...
                className={`relative cursor-pointer border-[color:var(--border-muted)] shadow-[0_25px_60px_-50px_rgba(15,23,42,0.18)] transition hover:-translate-y-0.5 ${
                  selectedTier === tierId
                    ...
                    : ""
                } ${tier.recommended ? "mt-7 border-2 border-[color:var(--brand)]" : ""}`}
