...
export const metadata: Metadata = {
  title: "Legal",
  description: "Review ProbateDesk terms, privacy commitments, and disclaimer.",
};
    ...
    <div className="space-y-12 pb-16">
      <header className="space-y-4">
        ...
        <p className="max-w-3xl text-base text-[#333333]">
          Transparency matters. Review how ProbateDesk works, how we handle your information, and important disclaimers.
        </p>
      </header>
