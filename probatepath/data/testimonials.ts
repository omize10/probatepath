...
export const testimonials: Testimonial[] = [
  {
    ...
    quote:
      "I had no idea where to start with probate. ProbatePath broke everything into clear steps and told me exactly what information I needed to gather. I went from a stack of random papers to a complete package that actually made sense.",
  },
  {
  ...
  },
  {
    ...
    quote:
      "Before ProbatePath I kept reading government PDFs and getting lost in them. The system asked targeted questions and then told me which forms applied in my situation. I stopped worrying that I had missed some secret extra form.",
  },
];
