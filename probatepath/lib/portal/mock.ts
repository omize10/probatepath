...
const docIntro = `<section style="font-family: 'Inter', Arial, sans-serif; color:#111827; line-height:1.6;">
  <header style="margin-bottom: 24px;">
    <p style="font-size:12px; letter-spacing:0.3em; text-transform:uppercase; color:#475569;">ProbateDesk</p>
...
export const portalDocuments: PortalDocumentTemplate[] = [
  {
    ...
    html: `${docIntro}
      <article>
        ...
        <p>We enclose the filing-ready package prepared through ProbateDesk's document preparation workflow. The executor remains self-represented and is responsible for court fees.</p>
        <ul>
