...
export function generateP24HTML(data: P24Data): string {
...
<head>
  ...
  <title>Form P24 - Affidavit in Support of Application for Resealing</title>
  <style>
    @page {
      size: 8.5in 11in;
      margin: 0.5in 0.75in;
...
<div class="form-header">
  <div class="form-number">Form P24 (Rule 25-6 (2))</div>
</div>
...
<div class="form-title">Affidavit in Support of Application for Resealing</div>
...
<!-- Paragraph 1 -->
<div class="paragraph">
  1 I am an applicant referred to in the submission for resealing in relation to the estate of <span class="field-line">${formatFullNameCaps(data.deceased)}</span> (the "deceased").
</div>
...
<div class="checkbox-item">
  <span class="checkbox">${checkbox(!!(data.isAlsoSwornP22 || data.isAlsoSwornP23))}</span>
  <span>I am also the applicant who swore the Form P22 or P23 affidavit filed with the submission for resealing.</span>
</div>

<div class="checkbox-item">
  <span class="checkbox">${checkbox(!(data.isAlsoSwornP22 || data.isAlsoSwornP23))}</span>
  <span>I am not the applicant who swore the Form P22 or P23 affidavit filed with the submission for resealing.</span>
</div>

<!-- Paragraph 3 -->
<div class="paragraph">
  3 I will administer according to law all of the deceased's estate to which the resealed grant applies, I will prepare an accounting as to how the estate comprising the assets to which the resealed grant applies was administered and how those assets were distributed, and I acknowledge that, in doing this, I will be subject to the legal responsibility of a personal representative.
</div>
